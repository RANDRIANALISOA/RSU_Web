...
.ruban{display:inline-block;margin-top:0.75rem;font-size:0.6875rem;font-weight:700;
  color:#8a5a00;background:#fff4d6;border:1px solid #f0d38a;border-radius:62.4375rem;
